<%@ Page Language="C#" AutoEventWireup="true" CodeFile="depart_add.aspx.cs" Inherits="depart_add" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtdeptname" runat="server" Width="200px" CssClass="tinput"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		排序标志
...
<script type="text/javascript">
    ...
    function checkQuery() {
        if ($.trim($("#txtdeptname").val()) == "") { alert("部门名称不能为空"); return false; }
