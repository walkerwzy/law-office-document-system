<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zhanlue.aspx.cs" Inherits="zhanlue" %>
...
<div id="container">
    ...
    <script type="text/javascript">
        $(function () {
            var dlgAdd = $("#btnedit").dialog({ id: 'cdg01', title: '编辑', page: 'officeedit.aspx?type=zhanlue&t=' + new Date().getMilliseconds() + '&url=' + location.pathname,
