<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cate_cust.aspx.cs" Inherits="cate_cust" %>
...
<head>
	...
	<script type="text/javascript">
	    ...
	    //弹窗_编辑
	    function detail() {
	        var dlg = new $.dialog({ id: "dg02", title: '添加客户类别', page: "cate_cust_add.aspx", resize: false, width: 500, height: 200, cover: true, rang: true, cancelBtn: false });
	        dlg.ShowDialog();
	    }        
        </script>
</head>
<body>
    ...
    <asp:GridView ID="gridlist" runat="server" DataKeyNames="cateid" 
            ...
            onrowdeleted="gridlist_RowDeleted" OnRowDataBound="rowbound" OnRowUpdated="gridlist_RowUpdated">
        <Columns>
        ...
        <asp:TemplateField HeaderText="客户类别" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="140px" HeaderStyle-Width="140px">
        ...
        <asp:TemplateField HeaderText="负责部门" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="100px" HeaderStyle-Width="100px">
            <ItemTemplate>
                <asp:DropDownList ID="ddldeptcode2" runat="server" DataSourceID="odsdept" CssClass="tinput" Width="95px" DataTextField="deptname" DataValueField="deptid" selectedvalue='<%# Bind("deptid") %>' Enabled="false" ForeColor="Black" BackColor="White"></asp:DropDownList></ItemTemplate>
            <EditItemTemplate>
                <asp:DropDownList ID="ddldeptcode" runat="server" DataSourceID="odsdept" CssClass="tinput" Width="95px" DataTextField="deptname" DataValueField="deptid" selectedvalue='<%# Bind("deptid") %>'></asp:DropDownList>
            </EditItemTemplate>
        </asp:TemplateField>
    ...
    <div class="divpager">
        ...
        <asp:ObjectDataSource ID="ods" runat="server" 
            DataObjectTypeName="WZY.Model.CATE_CUST" DeleteMethod="Delete" InsertMethod="Add" 
            SelectMethod="GetList" TypeName="WZY.DAL.CATE_CUST" UpdateMethod="Update">
            <DeleteParameters>
