<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cate_case_add.aspx.cs" Inherits="cate_case_add" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtpre" runat="server" Width="200px" CssClass="tinput" MaxLength="1">C</asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		说明
...
<script type="text/javascript">
    ...
    function checkQuery() {
        ...
        var pre = $.trim($("#txtpre").val());
        if (pre == "") { alert("类别前缀不能为空"); return false; }
        else {if (!/[a-zA-Z]/.test(pre)) { alert("类别前缀只能填一个字母"); return false; }  }
