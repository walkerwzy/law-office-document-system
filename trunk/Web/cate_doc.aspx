<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cate_doc.aspx.cs" Inherits="cate_doc" %>
...
<head>
	...
	<script type="text/javascript">
	    ...
	    //弹窗_编辑
	    function detail() {
	        var dlg = new $.dialog({ id: "dg02", title: '添加文档类别', page: "cate_doc_add.aspx", resize: false, width: 500, height: 200, cover: true, rang: true, cancelBtn: false });
	        dlg.ShowDialog();
	    }        
        </script>
</head>
<body>
    ...
    <asp:GridView ID="gridlist" runat="server" DataKeyNames="cateid" 
        ...
        <asp:TemplateField HeaderText="文档类别" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="140px" HeaderStyle-Width="140px">
    ...
    <div class="divpager">
        ...
        <asp:ObjectDataSource ID="ods" runat="server" 
            DataObjectTypeName="WZY.Model.CATE_DOC" DeleteMethod="Delete" InsertMethod="Add" 
            SelectMethod="GetList" TypeName="WZY.DAL.CATE_DOC" UpdateMethod="Update">
            <DeleteParameters>
